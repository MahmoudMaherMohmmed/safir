            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-black">
                        <div class="box-title">
                            <h3><i class="fa fa-table"></i> @lang('messages.trips.trips')</h3>
                        </div>
                        <div class="box-content">
                            <div class="btn-toolbar pull-right">
                                <div class="btn-group">
                                    @if (get_action_icons('trip/create', 'get'))
                                        <a class="btn btn-circle show-tooltip" title=""
                                            href="{{ url('trip/create') }}" data-original-title="Add new record"><i
                                                class="fa fa-plus"></i></a>
                                    @endif
                                    <?php $table_name = 'trips';
                                            ...
                                            <tr>
                                                ...
                                                <td class="visible-md visible-xs visible-sm visible-lg">
                                                    <div class="btn-group">
                                                        ...
                                                        @endif
                                                        @if (get_action_icons('trip/{id}/delete', 'get'))
                                                            <form action="{{ route('trip.destroy', $value->id) }}"
